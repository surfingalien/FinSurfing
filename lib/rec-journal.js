...
// Canonical JSON (sorted keys) so hashing is key-order independent. Shared
// with strategy-library via lib/canonical-json.js — the two carried identical
// private copies, and duplicated hashing logic silently breaks verification of
// already-written chains the moment one copy is changed and the other isn't.
