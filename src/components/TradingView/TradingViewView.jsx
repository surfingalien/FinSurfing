...
function normalise(raw) {
  ...
  const cryptoMap = {
    ...
    'ATOM-USD':  'BINANCE:ATOMUSDT', 'FIL-USD':   'BINANCE:FILUSDT',
    'TRX-USD':   'BINANCE:TRXUSDT',  'ICP-USD':   'BINANCE:ICPUSDT',
    'HBAR-USD':  'BINANCE:HBARUSDT', 'FTM-USD':   'BINANCE:FTMUSDT',
    'ALGO-USD':  'BINANCE:ALGOUSDT', 'VET-USD':   'BINANCE:VETUSDT',
    'EOS-USD':   'BINANCE:EOSUSDT',  'ZEC-USD':   'BINANCE:ZECUSDT',
    'ETC-USD':   'BINANCE:ETCUSDT',  'XMR-USD':   'KRAKEN:XMRUSD',
    'EGLD-USD':  'BINANCE:EGLDUSDT', 'KAVA-USD':  'BINANCE:KAVAUSDT',
    'TIA-USD':   'BINANCE:TIAUSDT',  'JUP-USD':   'BINANCE:JUPUSDT',
    // L2
    ...
    'IMX-USD':   'BINANCE:IMXUSDT',  'MNT-USD':   'BINANCE:MNTUSDT',
    'STRK-USD':  'BINANCE:STRKUSDT', 'ZK-USD':    'BINANCE:ZKUSDT',
    'METIS-USD': 'BINANCE:METISUSDT','MANTA-USD':  'BINANCE:MANTAUSDT',
    'ROSE-USD':  'BINANCE:ROSEUSDT',
    // DeFi
    'AAVE-USD':  'BINANCE:AAVEUSDT', 'MKR-USD':   'BINANCE:MKRUSDT',
    'COMP-USD':  'BINANCE:COMPUSDT', 'SNX-USD':   'BINANCE:SNXUSDT',
    'CRV-USD':   'BINANCE:CRVUSDT',  'SUSHI-USD': 'BINANCE:SUSHIUSDT',
    'DYDX-USD':  'BINANCE:DYDXUSDT', 'GMX-USD':   'BINANCE:GMXUSDT',
    'PENDLE-USD':'BINANCE:PENDLEUSDT','LDO-USD':   'BINANCE:LDOUSDT',
    'RPL-USD':   'BINANCE:RPLUSDT',  'RUNE-USD':  'BINANCE:RUNEUSDT',
    'BAL-USD':   'BINANCE:BALUSDT',  '1INCH-USD': 'BINANCE:1INCHUSDT',
    'CAKE-USD':  'BINANCE:CAKEUSDT',
    // AI
    'FET-USD':   'BINANCE:FETUSDT',  'OCEAN-USD': 'BINANCE:OCEANUSDT',
    'AGIX-USD':  'BINANCE:AGIXUSDT', 'RNDR-USD':  'BINANCE:RNDRUSDT',
    'WLD-USD':   'BINANCE:WLDUSDT',  'GRT-USD':   'BINANCE:GRTUSDT',
    'TAO-USD':   'BINANCE:TAOUSDT',  'ARKM-USD':  'BINANCE:ARKMUSDT',
    // Meme
    'BONK-USD':  'BINANCE:BONKUSDT', 'FLOKI-USD': 'BINANCE:FLOKIUSDT',
    'MEME-USD':  'BINANCE:MEMEUSDT', 'BOME-USD':  'BINANCE:BOMEUSDT',
    'TURBO-USD': 'BINANCE:TURBOUSDT','ORDI-USD':  'BINANCE:ORDIUSDT',
    // Infra
    'HNT-USD':   'BINANCE:HNTUSDT',  'AR-USD':    'BINANCE:ARUSDT',
    'STORJ-USD': 'BINANCE:STORJUSDT','ANKR-USD':  'BINANCE:ANKRUSDT',
    'BAND-USD':  'BINANCE:BANDUSDT', 'THETA-USD': 'BINANCE:THETAUSDT',
    // Exchange
    'CRO-USD':   'BINANCE:CROUSDT',  'STX-USD':   'BINANCE:STXUSDT',
    'GALA-USD':  'BINANCE:GALAUSDT', 'MANA-USD':  'BINANCE:MANAUSDT',
    'SAND-USD':  'BINANCE:SANDUSDT', 'AXS-USD':   'BINANCE:AXSUSDT',
    'JTO-USD':   'BINANCE:JTOUSDT',  'PYTH-USD':  'BINANCE:PYTHUSDT',
    'SEI-USD':   'BINANCE:SEIUSDT',  'ZETA-USD':  'BINANCE:ZETAUSDT',
    'BLUR-USD':  'BINANCE:BLURUSDT', 'BAT-USD':   'BINANCE:BATUSDT',
    // ── Bare tickers ──────────────────────────────────────────────────
    ...
    'HBAR': 'BINANCE:HBARUSDT',  'FTM':  'BINANCE:FTMUSDT',
    'ALGO': 'BINANCE:ALGOUSDT',  'VET':  'BINANCE:VETUSDT',
    'EOS':  'BINANCE:EOSUSDT',   'ZEC':  'BINANCE:ZECUSDT',
    'ETC':  'BINANCE:ETCUSDT',   'XMR':  'KRAKEN:XMRUSD',
    'EGLD': 'BINANCE:EGLDUSDT',  'KAVA': 'BINANCE:KAVAUSDT',
    'TIA':  'BINANCE:TIAUSDT',   'JUP':  'BINANCE:JUPUSDT',
    'IMX':  'BINANCE:IMXUSDT',   'MNT':  'BINANCE:MNTUSDT',
    'STRK': 'BINANCE:STRKUSDT',  'ZK':   'BINANCE:ZKUSDT',
    'METIS':'BINANCE:METISUSDT', 'MANTA':'BINANCE:MANTAUSDT',
    'ROSE': 'BINANCE:ROSEUSDT',  'AAVE': 'BINANCE:AAVEUSDT',
    'MKR':  'BINANCE:MKRUSDT',   'COMP': 'BINANCE:COMPUSDT',
    'SNX':  'BINANCE:SNXUSDT',   'CRV':  'BINANCE:CRVUSDT',
    'SUSHI':'BINANCE:SUSHIUSDT', 'DYDX': 'BINANCE:DYDXUSDT',
    'GMX':  'BINANCE:GMXUSDT',   'PENDLE':'BINANCE:PENDLEUSDT',
    'LDO':  'BINANCE:LDOUSDT',   'RPL':  'BINANCE:RPLUSDT',
    'RUNE': 'BINANCE:RUNEUSDT',  'BAL':  'BINANCE:BALUSDT',
    '1INCH':'BINANCE:1INCHUSDT', 'CAKE': 'BINANCE:CAKEUSDT',
    'FET':  'BINANCE:FETUSDT',   'OCEAN':'BINANCE:OCEANUSDT',
    'AGIX': 'BINANCE:AGIXUSDT',  'RNDR': 'BINANCE:RNDRUSDT',
    'WLD':  'BINANCE:WLDUSDT',   'GRT':  'BINANCE:GRTUSDT',
    'TAO':  'BINANCE:TAOUSDT',   'ARKM': 'BINANCE:ARKMUSDT',
    'BONK': 'BINANCE:BONKUSDT',  'FLOKI':'BINANCE:FLOKIUSDT',
    'MEME': 'BINANCE:MEMEUSDT',  'BOME': 'BINANCE:BOMEUSDT',
    'TURBO':'BINANCE:TURBOUSDT', 'ORDI': 'BINANCE:ORDIUSDT',
    'HNT':  'BINANCE:HNTUSDT',   'AR':   'BINANCE:ARUSDT',
    'STORJ':'BINANCE:STORJUSDT', 'ANKR': 'BINANCE:ANKRUSDT',
    'BAND': 'BINANCE:BANDUSDT',  'THETA':'BINANCE:THETAUSDT',
    'CRO':  'BINANCE:CROUSDT',   'STX':  'BINANCE:STXUSDT',
    'GALA': 'BINANCE:GALAUSDT',  'MANA': 'BINANCE:MANAUSDT',
    'SAND': 'BINANCE:SANDUSDT',  'AXS':  'BINANCE:AXSUSDT',
    'JTO':  'BINANCE:JTOUSDT',   'PYTH': 'BINANCE:PYTHUSDT',
    'SEI':  'BINANCE:SEIUSDT',   'ZETA': 'BINANCE:ZETAUSDT',
    'BLUR': 'BINANCE:BLURUSDT',  'BAT':  'BINANCE:BATUSDT',
  }
